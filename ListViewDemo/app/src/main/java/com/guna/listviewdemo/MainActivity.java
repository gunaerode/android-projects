...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        familyArray.add("Ram");
        familyArray.add("Sita");
        familyArray.add("Lakshman");
        familyArray.add("Hanuman");

        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, familyArray);
        // set array views to adapter
        listView.setAdapter(arrayAdapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MainActivity.this, "Hey " + familyArray.get(position), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
